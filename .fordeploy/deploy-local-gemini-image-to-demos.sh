...
set_key SPRING_IS_COOL_AI_MONTHLY_CALL_LIMIT 250
...
grep -E '^(SPRING_IS_COOL_AI_ENABLED|SPRING_IS_COOL_AI_PROVIDER|SPRING_IS_COOL_AI_MONTHLY_CALL_LIMIT|GOOGLE_CLOUD_LOCATION|VERTEX_AI_MODEL_ID|GOOGLE_APPLICATION_CREDENTIALS)=' "$ENV_FILE"
REMOTE_PREP
